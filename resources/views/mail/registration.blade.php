...
<head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
        ...
        .button {
            ...
            border-right: 18px solid #004389;
            border-bottom: 10px solid #004389;
            border-left: 18px solid #004389;
        ...
        .button--red {
            ...
            border-top: 10px solid #0399d8;
            border-right: 18px solid #0399d8;
            border-bottom: 10px solid #0399d8;
            border-left: 18px solid #0399d8;
        }
...
<span class="preheader"
      style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;"> Thank you for register!. </span>
            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td class="email-masthead"
                        style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding:0;"
                        align="center">
                        <a href="{{ URL::to('/') }}" class="f-fallback email-masthead_name"
                           style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                            <img style="max-width: 500px;" src="{{ asset('/top.jpg') }}"
                                 alt="">
                        </a>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <div class="f-fallback">
                                        ...
                                        <ul>
                                            <li style=" font-weight:bold; font-size: 16px;line-height: 1.625;color: #171515; margin: 0;">
                                                First Name: <strong
                                                    style="color: #0399d8;"> {{ $data[ 'first_name' ] }} </strong></li>
                                            <li style=" font-weight:bold; font-size: 16px;line-height: 1.625;color: #171515;margin: .4em 0 1.1875em;">
                                                Last Name: <strong
                                                    style="color: #0399d8;"> {{ $data[ 'last_name' ] }} </strong></li>
                                            <li style=" font-weight:bold; font-size: 16px;line-height: 1.625;color: #171515;margin: .4em 0 1.1875em;">
                                                Email: <strong
                                                        style="color: #0399d8;"> {{ $data[ 'email' ] }} </strong>
                                            </li>
                                            <li style=" font-weight:bold; font-size: 16px;line-height: 1.625;color: #171515;margin: .4em 0 1.1875em;">
                                                Company / Institution: <strong
                                                    style="color: #0399d8;"> {{ $data[ 'company' ] }} </strong></li>
                                            <li style=" font-weight:bold; font-size: 16px;line-height: 1.625;color: #171515;margin: .4em 0 1.1875em;">
                                                Attend: <strong
                                                style="color: #0399d8;"> {{ $data[ 'attend' ] }} </strong></li>
                                            <li style=" font-weight:bold; font-size: 16px;line-height: 1.625;color: #171515;margin: .4em 0 1.1875em;">
                                                Expertise: <strong
                                                style="color: #0399d8;"> {{ $data[ 'expertise' ] }} </strong></li>
                                        </ul>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p class="f-fallback sub align-center"
                                       ...
                                       align="center"> DOMINICAN MEDICAL-DENTAL SOCIETY</p>
                                    <p class="f-fallback sub align-center"
                                       style="font-size: 13px; line-height: 1.625; text-align: center; color: #6B6E76; margin: .4em 0 1.1875em;"
                                       align="center">
                                        2020
